...
vue_dist_vue_esm_js__WEBPACK_IMPORTED_MODULE_2__.default.use(vue_router__WEBPACK_IMPORTED_MODULE_3__.default); // パスとコンポーネントのマッピング
...
new vue_dist_vue_esm_js__WEBPACK_IMPORTED_MODULE_2__.default({
  el: '#app',
